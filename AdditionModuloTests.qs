namespace DisabledTests
{
    ...
    operation DeterministicModularAdditionWithSmallNTest () : Unit
    {
        using (a = Qubit[4]) {
        using (b = Qubit[4]) {
        using (N = Qubit[4])
    ...
    operation DeterministicModularAdditionWithLargeNTest () : Unit
    {
        using (a = Qubit[4]) {
        using (b = Qubit[4]) {
        using (N = Qubit[4])
    ...
    operation ModularDisjointUncertaintyWithSmallNTest () : Unit
    {
        using (a = Qubit[4]) {
        using (b = Qubit[4]) {
        using (N = Qubit[4])
    ...
    operation ModularDisjointUncertaintyWithMiddleNTest () : Unit
    {
        using (a = Qubit[4]) {
        using (b = Qubit[4]) {
        using (N = Qubit[4])
    ...
    operation ModularMultipleJointUncertaintyWithLargeNTest () : Unit
    {
        using (a = Qubit[4]) {
        using (b = Qubit[4]) {
        using (N = Qubit[4])
